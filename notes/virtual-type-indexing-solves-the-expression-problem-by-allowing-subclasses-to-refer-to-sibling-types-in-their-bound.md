...
The alternative approach is [[algebraic-effects-implement-domain-specific-dsls-by-separating-the-operation-interface-from-evaluation-strategy]]: instead of solving the expression problem at the type level (virtual types, GATs), algebraic effects solve the extensibility problem at the semantics level -- operations can be added independently of their handlers, and handlers can be added independently of the operations they interpret. The categorical explanation ([[algebraic-operations-and-effect-handlers-are-categorically-dual-as-constructors-and-deconstructors]]) is that this constructor/destructor duality is the free-model analog of the cases/operations duality in the expression problem table.
