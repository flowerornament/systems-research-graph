...
- [[unbounded-execution-time-is-the-single-root-cause-of-all-audio-glitches-not-just-slowness]] -- Bencina 2011 provides the unifying principle: all the specific failure modes here are instances of unbounded execution time; "if you don't know how long it will take, don't do it"
- [[priority-inversion-blocks-the-rt-thread-behind-a-lower-priority-task-on-general-purpose-oses]] -- the priority inversion failure mode listed here is detailed in that claim: the full three-step mechanism with scheduling analysis
