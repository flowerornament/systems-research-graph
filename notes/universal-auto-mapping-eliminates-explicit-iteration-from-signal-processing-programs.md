...
McCartney traces this to APL/J (rank-polymorphic operations are the semantic core, without APL's symbolic syntax) and F#'s `@` operators. He's explicit: he wants APL's density of expression without "Chinese" notation.
