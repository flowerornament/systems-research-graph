---
description: Treating if/switch/for as primitive graph nodes on equal footing with arithmetic and delay creates genuinely conditional multi-rate synthesis, enabling pause and demand-rate patterns that no other audio language currently supports
type: claim
evidence: moderate
