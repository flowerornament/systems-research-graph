---
description: When UGens are library functions over four primitives (constants, math, delays, control flow) rather than opaque objects, the compiler sees the full graph and can fuse, vectorize, and eliminate dead nodes
type: claim
evidence: moderate
