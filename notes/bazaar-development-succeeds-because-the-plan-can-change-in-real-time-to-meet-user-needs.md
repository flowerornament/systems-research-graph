...
McLean's Tidal development is the music-language instance of the bazaar model: [[iterative-redesign-of-core-representations-through-live-performance-is-the-correct-evaluation-methodology-for-music-programming-languages]] describes five or more major representation rewrites, each driven by performer feedback and community practice. The "plan that changes in real time" is McLean responding to his own live use and user reports; the "curator" is McLean deciding which representations survive and which are abandoned. The performance evaluation loop is the bazaar's feedback mechanism adapted to a domain where users and the lead developer are often the same person.
