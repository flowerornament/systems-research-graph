...
Contrasts with the motivation for differentiable signal processing generally -- the DDSP paper [[ddsp-oscillator-models-bridge-neural-synthesis-and-physical-acoustics]] targets precisely the subclass of synthesis operations that remain differentiable.
