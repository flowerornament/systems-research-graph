---
description: A functor is locally contractive if its action on hom-objects factors through ◮; this syntactically checkable condition guarantees a unique fixed point that is both initial algebra and final coalgebra
type: property
evidence: strong
