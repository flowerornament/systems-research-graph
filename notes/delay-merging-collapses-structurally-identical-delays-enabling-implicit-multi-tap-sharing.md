---
description: When two delays have identical inputs and initialization, the compiler collapses them into one, so multiple UGen-style library functions share the same delay line without explicit coordination
type: pattern
evidence: moderate
