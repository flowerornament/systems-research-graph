...
- Extended by [[gctt-semantics-requires-presheaves-over-the-product-of-the-cube-category-and-the-natural-numbers-poset]]: the topos of trees (presheaves over ω) is the ω-factor of C × ω in GCTT; the C-factor adds path equality, allowing not just type construction but also *proof* of extensional properties of guarded recursive types via [[path-types-in-gctt-enable-proving-properties-of-guarded-recursive-programs-not-just-defining-them]]
