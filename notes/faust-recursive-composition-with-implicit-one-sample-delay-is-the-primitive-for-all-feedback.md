...
- The Murail substrate generalizes this approach: [[guarded-self-reference-is-the-sole-mechanism-for-temporal-evolution-in-the-murail-calculus]] makes the delay amount an explicit annotation rather than an implicit one-sample assumption, and [[the-causality-condition-requires-every-dependency-cycle-to-contain-a-delay-edge]] is the formal generalization of FAUST's one-sample rule to arbitrary multi-tap delays
