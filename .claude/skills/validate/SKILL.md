---
name: validate
description: Schema validation for claims. Checks against domain-specific templates. Validates required fields, enum values, description quality, and link health. Non-blocking — warns but doesn't prevent capture. Triggers on "/validate", "/validate [claim]", "check schema", "validate claim", "validate all".
user-invocable: true
